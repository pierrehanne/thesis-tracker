...
class TestLoggingSetup(unittest.TestCase):
    ...
    def test_log_output(self):
        ...
        with StringIO() as log_output:
            ...
            self.assertIn(log_message, log_output_content, "Log message was not found in the console output")

        # Verify that the message is in the log file
        with open(self.log_file_path, 'r') as log_file:
            log_file_content = log_file.read()
            self.assertIn(log_message, log_file_content, "Log message was not found in the log file")
