...
def test_format_theses_data():
    ...
    data = pd.DataFrame(
        {
            "subjects": [
                [
                    {"langue": "fr", "libelle": "Responsabilité"},
                    {"langue": "en", "libelle": "Responsibility"},
                ],
                [
                    {"langue": "fr", "libelle": "Science"},
                    {"langue": "en", "libelle": "Science"},
                ],
            ],
    ...
    # Ensure duplicates are removed / NaN values are filled
